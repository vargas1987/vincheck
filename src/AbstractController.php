...
abstract class AbstractController extends BaseController
{
     ...
     * @return string
     */
    protected function getLastRouteUrl($request, $defaultRoute, $defaultParams = [])
    {
        ...
        try {
            ...
            return $this->generateUrl($defaultRoute, $defaultParams);
        }
    }
     ...
     * @param string     $msg
     */
    protected function logException(\Throwable $exception, $msg = null)
    {
        $this->getLogger()->addError($msg ?: $exception->getMessage(), ['exception' => $exception]);
    }
}
